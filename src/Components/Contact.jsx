const Contact = () => {
    ...
    return (
        <div className="bg-slate-800 flex justify-center items-center h-[350px] sm:flex sm:justify-center sm:items-center sm:h-[350px] md:flex md:justify-center md:items-center md:h-[666px] lg:flex lg:justify-center lg:items-center lg:h-[666px]">
